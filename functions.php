<?php
/**
 * Mínimo functions and definitions
 *
...
function minimo_setup() {
	 ...
	 * If you're building a theme based on Mínimo, use a find and replace
...
function minimo_scripts() {
	...
	wp_enqueue_script( 'minimo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'minimo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
